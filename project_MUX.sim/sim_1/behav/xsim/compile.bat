...
REM
REM Generated by Vivado on Fri Oct 24 20:07:11 +0200 2025
...
echo "xvhdl --incr --relax -prj tb_mux_2to1_vhdl.prj"
call xvhdl  --incr --relax -prj tb_mux_2to1_vhdl.prj -log xvhdl.log

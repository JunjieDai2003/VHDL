...
architecture ascensor of FSM is
 ...
 ---------------------------------------------------------------------
    signal s_piso_actual: unsigned(3 downto 0):="0000";
    signal s_piso_final: unsigned(3 downto 0):="0000";
 ---------------------------------------------------------------------
    ...
    begin
        ...
        case current_state is
            when REPOSO =>
                ...
                if planta_1 = '1' then
                    next_s_piso_final <= "0000";
                elsif planta_2 = '1' then
                    next_s_piso_final <= "0001";
                elsif planta_3 = '1' then
                    next_s_piso_final <= "0010";
                elsif planta_4 = '1' then
                    next_s_piso_final <= "0011";
                end if;

...
entity top is
    PORT(
        ...
        --fin de carrera de motor
        sensor  : in  std_logic;
        -- motor sube o baja o reposo
...
architecture structural of top is
    -- las señales para comunicar entre sincronizador-flanco flanco-maquina
    ...
    --señal de mi piso y de piso destino
    ...
    COMPONENT FSM is 
        port(
            ...
            -- ENTRADA DE USUARIO
            planta_1      : in  std_logic;
            planta_2      : in  std_logic;
            planta_3      : in  std_logic;
            planta_4      : in  std_logic;
...
begin 
    ...
    Inst_decoder : decoder PORT MAP ( 
        clk          => clk,
        rst          => rst,
        mi_piso      => piso_actual_s, 
        destino_piso => piso_final_s, 
        an           => an,                  
        led          => segment
    );
    ...
    -- activo el timer cuando el motor esta funcionando
    timer_enable <= motor_s(0) or motor_s(1); --01 11
    
    --no puedo usar una expresion lógica para conectar con un puerto, por eso
